                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <p class="mb-0 text-white text-center fw-bold"><?=T::tour." ".T::booking?></p>
                        </div>
                    ...
                    <div class="form-content">
                        <div class="card-item shadow-none radius-none mb-0">
                            <div class="card-img pb-2">
                             <img class="lazyload" src="<?php if (isset($booking_data['tour_img'])){ echo root."uploads/".$booking_data['tour_img']; } else { echo root."assets/img/hotel.jpg";} ?>" alt="img">
                            </div>

                            <div class="card-body p-0">
                                <div class="d-flex justify-content-between">
                                    <div>
                                     <?php for ($i = 1; $i <= $booking_data['tour_stars']; $i++) { star(); } ?>

                                        <h3 class="card-title fw-bold text-white"><?=$booking_data['tours_name']?></h3>
                                        <p class="card-meta" style="line-height:18px"><?=$booking_data['tour_location']?></p>
                                    </div>
                                    <!--<div>
                                ...
                                <p class="mt-2"><?=$booking_data['tour_type']?></p>
                                <ul class="list-items list-items-2 py-3">
                                    <li><span><?=T::total?> <?=T::travellers?>:</span><?=$booking_data['adults']+$booking_data['childs']?>
                                    <li><span><?=T::total?> <?=T::price?>:</span><?=$booking_data['currency_markup']?> <?=number_format($booking_data['total_price'],2);?></li>
                                ...
                                <ul class="list-items list-items-2 pt-3">
                                    <li><span><?=T::sub_total?>:</span><?=currency?> <?= number_format( $booking_data['total_price'],2) ?> </li>
                                    <li><span><?=T::service_fee?>:</span><?=currency?> <?=number_format( 0,2) ?></li>
                                    <hr>
                                    <li style="font-size:22px"><span><?=T::price?>:</span><strong><?=currency?> <?=number_format( $booking_data['total_price'],2);?> </strong></li>
                                    <hr>
                                </ul>
                            </div>
