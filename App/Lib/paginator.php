...
class Paginator
{
    ...
    protected $previousText = T::previous;
    protected $nextText = T::next;
    ...
    public function toHtml()
    {
        ...
        $html = '<ul class="paginate d-flex justify-content-center gap-2">';
        if ($this->getPrevUrl()) {
        ...
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                if($page['isCurrent']==1){$active="active";} else {$active="";};
                $html .= '<li class=""><a class="page-link '.$active.'" href="' . htmlspecialchars($page['url']) . '">' . htmlspecialchars($page['num']) . '</a></li>';
            } else {
                $html .= '<li class="page-item disabled"><a class="page-link" href="#">' . htmlspecialchars($page['num']) . '</a></li>';
            }
        }
